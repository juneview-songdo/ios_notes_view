...
class FolderItemView extends StatefulWidget {
  ...
  @override
  State<FolderItemView> createState() => StateChild();
}

class FolderItemViewState extends State<FolderItemView> with StateMother {
  @override
...
main() async {
  return buildApp(appHome: FolderItemView(
    numberOfFiles: "2",
    folderName: "Notes",
  ));
}
